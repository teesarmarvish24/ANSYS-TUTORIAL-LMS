...
export default function AssignmentSubmissionForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-navy-900 mb-1.5">Your answer</label>
        <textarea
          value={content}
      ...
      <div>
        ...
        <FileUploadField
          pathPrefix={`submissions/${userId}/assignments/${assignmentId}`}
          value={attachment}
      ...
      {saved && <p className="text-sm text-emerald-700">Submission saved.</p>}
