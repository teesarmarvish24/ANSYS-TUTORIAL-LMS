...
export default function GoogleButton({ label = 'Continue with Google' }: { label?: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 text-sm font-medium text-navy-900 hover:bg-gray-50 transition-colors"
    >
